...
%%% TODO check here, what is a style guide? maybe need to figure this out...
...
\usepackage[sectionbib,numbers, sort]{natbib} % numeric citations using natbib
...
% \chairdateapproved      {17 June 2017}
% \firstdateapproved      {17 June 2017}
% \seconddateapproved     {17 June 2017}
% \thirddateapproved      {17 June 2017}
% \fourthdateapproved     {17 June 2017}
...
%% TODO check bib style, change to IEEE? or see what is feasible? need to decide on this soon...
\bibliographystyle{acm}
% \bibliographystyle{siam} % default
...
% to create an index, see the additional template files for more details
