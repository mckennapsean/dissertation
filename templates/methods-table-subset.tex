...
\caption{\label{tbl:methods}
  Numerous exemplar methods and where they fit within the framework. We coded
  ...
  evaluative (\textbf{\emph{e}}), or both. We categorized the methods we
  ...
  assist designers in trying each method out. A more extensive list of 100
  methods is in Appendix~\ref{sec:app-methods}.
