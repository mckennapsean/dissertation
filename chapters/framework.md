...
articulate the motivation, artifacts, and the explicit link
back to the levels of the nested model.
...
work towards a specific artifact, or set of artifacts. Many
...
helps in choosing appropriate methods and identifying artifacts.


Next, **artifacts** are the specific, unique results
of a design activity, characterized by which
level or levels of the nested model they address. There is
a close connection of artifacts with **methods**,
which are actions or techniques that a designer employs to
either generate or evaluate artifacts. It is the application
...
to be divergent and create many artifacts, such as methods
...
artifacts, such as methods that elicit feedback from domain
...
user.* The artifacts of this activity are commonly referred
to as design
...
the data and task abstraction artifacts that have a potential
...
usability. Together, these three classes of artifacts for the
...
*understand* artifacts. At the technique level, the ideas
...
concretize ideas into tangible prototypes.* The artifact
...
motivations and artifacts for visualization design,
...
goals.* The overall artifact of this activity is a usable
...
Thus, the artifacts of the deploy stage touch on decisions
